...
<body>
                ...
                <div class="navBar">
                    <div class="dropdown">
                        ...
                        <ul class="dropdownContent">
                            ...
                            <li><button class="navSubLink here" onclick="location.href='polearms.php'" role="menuitem">Polearms</button></li>
    ...
    <section class="content">   
        ...
        <div class="availableWeapons" data-table="polearms">
